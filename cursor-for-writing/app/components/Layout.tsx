  ...
  const generateAIContent = async () => {
    ...
    try {
      ...
      if (data.type === 'chat') {
        ...
        // console.log("Handling as agent response"); // Log entering agent block
        // Handle document modifications
        if (data.type === 'modification' && data.modifications) {
          // console.log("Handling as modification"); // Log entering modification block
          ...
          // console.log("Handling as replacement"); 
          try {
            // console.log("Raw Markdown from API:", data.modifiedContent); 
            const htmlContent = marked(data.modifiedContent);
            // console.log("HTML Content generated by marked:", htmlContent); 
            // console.log("HTML Content for setContent:", htmlContent); 

            editor.commands.setContent(htmlContent); 
            
            // **** REMOVE ADDED LOGS ****
            // Immediately check what the editor thinks its content is
            // const editorContentAfterUpdate = editor.getHTML(); 
            // console.log("Editor HTML after setContent:", editorContentAfterUpdate); 
            // **** END REMOVE ADDED LOGS ****

            // Compare if needed:
            // if (htmlContent === editorContentAfterUpdate) {
            //   console.log("Editor content matches HTML set (potentially invisible?)");
            // } else {
            //   console.warn("Editor content DOES NOT match HTML set (setContent likely failed silently or partially)");
            // }
          ...
          // Log if it falls into the final else within agent mode
          // console.log("Agent mode, but no modification or replacement condition met. Data:", data);
